// LatestFeed.tsx - Shows posts in chronological order
...
const LatestFeed: React.FC<LatestFeedProps> = ({ keyPair }) => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        ...
        // Fetch posts from local database, sorted by timestamp (newest first)
        const latestPosts = await db.getLatestPosts(50); // Limit to 50 posts
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold text-gray-900">Latest Posts</h1>
      ...
      <CreatePost keyPair={keyPair} onPostCreated={handleNewPost} />
